...
sed -i -e "/telephony/d" -e "/video/d" feeds.conf.default
...
rm -Rf feeds/base_root/package/kernel/!(cryptodev-linux|bpf-headers|mac80211|linux) feeds/base_root/package/boot/uboot-!(tools)
